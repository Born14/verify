...
Now 5,694 automated scenarios across 18 staged files catch it — 333 tests with 21,321 assertions, 0 failures:
...
5,694 scenarios across 18 staged files exercise the verification pipeline's invariants. 727 per-gate scenarios cover 16 domains (a11y, config, content, db, f9, filesystem, g5, html, http, infrastructure, k5, message, performance, security, serialization, triangulation), plus 28 universal integration scenarios and 4,939 WPT-derived corpus scenarios. 18 harvest scripts in `scripts/harvest/` generate deterministic scenarios from real fixture data. 333 unit tests with 21,321 assertions, 0 failures.
